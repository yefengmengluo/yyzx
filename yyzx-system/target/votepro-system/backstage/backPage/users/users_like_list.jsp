...
<body>
	...
	<div class="t1000-votB-R-in clearfix">
    		<div class="t1000-siteManagement-tit clearfix">
                <h2 class="t1000-tit">站点管理</h2>
                 <form action="${pageContext.request.contextPath }/userController/queryUserLikeByPage?uPower=${sessionScope.user.userPower }&userId=${u.userId }" method="post" id="userselect" accept-charset="utf-8">
	                <span>输入站点名称</span>
	                <label><input type="text" class="t1000-com-search-con-text grayTips" id="keyWord" name="keyWord" value="请输入关键字"/></label>
               ...
               <%--   <a href="${pageContext.request.contextPath }/backstage/backPage/users/users_add.jsp"><input type="button" class="t1000-com-search-con-btn2" value="添加站点"/></a> --%>
                 <input type="button" class="t1000-com-search-con-btn2" value="添加站点" onclick="add()"/>
        ...
        <table class="memberList t1000-siteManagement" cellpadding="0" cellspacing="0">
            	<tr>
                    ...
                    <th class="vote_w1">站点名称</th>
                    <th class="vote_w1">网址</th>
                    <th class="vote_w3">账户号</th>
                    <th class="vote_w4">姓名</th>
                    <th>操作</th>
                </tr>
                ...
                <tr>
                    ...
                    <a class="del" href="${pageContext.request.contextPath }/userController/removeUser?uPower=${sessionScope.user.userPower }&deleteIds=${u.userId }&currentNum=${page.currentNum}">删除</a></td>
                </tr>
                </c:forEach>
...
<script type="text/javascript">
	...
	function pageSkip(pageNum){
		...
		//alert(keyWord)
			//location.href="${pageContext.request.contextPath }/userController/queryUserLikeByPage?uPower=${sessionScope.user.userPower }&currentNum="+pageNum;
		$("#userselect").attr("action","${pageContext.request.contextPath }/userController/queryUserLikeByPage?currentNum="+pageNum);
		$("#selectOk").click();
		}
		////跳转添加页
		function add(){
