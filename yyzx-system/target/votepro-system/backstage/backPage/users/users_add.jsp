	...
	<div class="t1000-votB-R-in">
        ...
        <table class="t1000-editTab" cellpadding="0" cellspacing="0">
                ...
                <tr>
                	<td class="w15">账户名</td>
                    <td width="*"><span>
                    <input class="t1000-company-text" type="text" id="account" name="account" value=""/><font color="red">   ( * 必填 )</font></span>
                ...
                <tr>
				 ...
				 <tr>
                    ...
                    <td width="*"><span class="t1000-vote-radio-con"><input class="t1000-vote-radio" id="userPower"  name="userPower" type="radio" value="1" checked />管理员<input class="t1000-vote-radio" type="radio" name="userPower" value="0"/>超级管理员</span></td>
                </tr>
