	...
	<div class="t1000-votB-R-in clearfix">
    	<div class="t1000-com-search-con clearfix">
            <h1  align="center" style="color:red; font-size:45px">评 论 排 行 榜</h1>
             <form action="${pageContext.request.contextPath }/CommentController/queryVoteItemLikeByUser" method="post" id="comselect">
	            <span>输入品牌名称</span>
	            <label><input type="text" class="t1000-com-search-con-text focusBlur grayTips" name="keyWord" value="${keyWord }"/></label>
        ...
        <table class="memberList commentTab" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td width="*"><a class="setData" href="${pageContext.request.contextPath }/CommentController/queryAllCommentByViId?viId=${p.viId}">查看评论详情</a></td>
                </tr>
                </c:forEach>
        </table>  
...
<script type="text/javascript" >
	function  pageSkip(num){
		...
		$("#comselect").attr("action","${pageContext.request.contextPath }/CommentController/queryAllVoteItemByCommentCount?currentNum="+num);
		$("#selectOk").click();
	}
</script>
</body>
