	...
	<div class="t1000-votB-R-in clearfix">
    		<div class="t1000-siteManagement-tit clearfix">
                <h2 class="t1000-tit">留言管理</h2>
                 <form action="${pageContext.request.contextPath }/liuYanController/sp_ly/queryLiuYanLikeByKey?uPower=${sessionScope.user.userPower }&userId=${u.userId }" method="post" id="liuyanselect" accept-charset="utf-8">
	                <span>输入公司名称</span>
        ...
        <table class="memberList t1000-siteManagement" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td width="*"><a class="setData" href="${pageContext.request.contextPath }/liuYanController/sp_ly/queryOneByLYId?uPower=${sessionScope.user.userPower }&lyId=${u.lyId}&currentNum=${page.currentNum}">编辑</a>
...
<script type="text/javascript">
	...
	function pageSkip(pageNum){
		...
		$("#liuyanselect").attr("action","${pageContext.request.contextPath }/liuYanController/sp_ly/queryLiuYanLikeByKey?currentNum="+pageNum);
		$("#selectOk").click();
		}
