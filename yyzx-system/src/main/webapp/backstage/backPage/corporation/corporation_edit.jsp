        ...
        <table class="t1000-editTab" cellpadding="0" cellspacing="0">
                ...
                <tr>
					...
					<c:choose>
	                    ...
	                    <c:otherwise>
	                    	<span id="logo_fileName" style="font-size:10pt;width:30%" >${company.logo}</span>
	                    </c:otherwise>
                    </c:choose>
                ...
                <tr>
					...
					<c:choose>
	                    ...
	                    <c:otherwise>
	                    	<span id="weixinPic_fileName" style="font-size:10pt">${company.weixinPic}</span>
	                    </c:otherwise>
                    </c:choose>
                    </td>
                </tr>
                <tr>
					...
					<c:choose>
	                    ...
	                    <c:otherwise>
	                    	<span id="weiboPic_fileName" style="font-size:10pt">${company.weiboPic}</span>
	                    </c:otherwise>
                    </c:choose>
                    </td>
                </tr>
                <tr>
					...
					<c:choose>
	                    ...
	                    <c:otherwise>
	                    	<span id="erweimaPic_fileName" style="font-size:10pt">${company.erweimaPic}</span>
	                    </c:otherwise>
                    </c:choose>
