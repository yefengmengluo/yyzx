...
<body>
	<div class="t1000-votB-R-in clearfix">
        ...
        <table class="t1000-editTab" cellpadding="0" cellspacing="0">
                    ...
                    <td width="*">
	                    <span class="t1000-vote-radio-con">
	                    	<c:if test="${voteTable.dataStatus==1}">
			                    <input class="t1000-vote-radio" name="dataStatus" type="radio" value="1" checked="checked" />开启
	                    	...
	                    	<c:if test="${voteTable.dataStatus==0}">
			                    ...
			                    <input class="t1000-vote-radio" type="radio" name="dataStatus" value="0" checked="checked"/>关闭
	                    	</c:if>
	                    </span>
                    </td>
                </tr>
                ...
                <tr>
                	<td class="w15">链接主题</td>
                    <td width="*" id="ztlj">
                	 <span class="t1000-vote-radio-con">
	                   	<input class="click_d t1000-vote-radio" type="radio" name="ztlj" checked="checked"/>品牌排行
	                   	<input class="click_d t1000-vote-radio" type="radio" name="ztlj"/>企业排行
	                   	</span>
                    </td>
                </tr>
                
                <tr>
                	<td class="w15">链接内容</td>
                    <td width="*" id="link_con">
                    	<span class="t1000-vote-radio-con" style="padding-left: 20px; display:block;">
                    		品牌排行:http://toupiao.99114.com/VoteItemStuff/selectVoteItemList/voteIndex/${voteTable.id}?tlength=9
                    		<br/>
                    		品牌列表:http://toupiao.99114.com/VoteItemStuff/selectVoteItemList/listCorp/${voteTable.id}
                    	</span>
                    	
                    	<span class="t1000-vote-radio-con" style="padding-left: 20px">
                    		&lt;iframe src="http://toupiao.99114.com/selectChannel/companyVote/${voteTable.id}" style="width:100%;height:100%;border:0" scrolling="no">&lt;/iframe>
                   		 </span>
                    </td>
                </tr>
                ...
                <tr>
                	<td class="t1000-company-btn" colspan="2">
                        <span>
                            ...
                            <input id="returnBtn" type="button" class="t1000-batch-btn2" value="取消" onclick="javascript:history.go(-1)"/>
                        </span>
                    </td>
                </tr>
        </table>  
...
$(function(){
	...
	$(".click_d").click(function(){
		var inpInd=$(this).index();
		$("#link_con span").eq(inpInd).show().siblings().hide();
	})
